...
export class Ships {
  static LIGHT_FIGHTER: Readonly<Ship> = {
    id: 204,
    type: AssetType.Ship,
    name: "Light Fighter",
    combat: true,
  ...
  static HEAVY_FIGHTER: Readonly<Ship> = {
    id: 205,
    type: AssetType.Ship,
    name: "Heavy Fighter",
    combat: true,
  ...
  static BATTLESHIP: Readonly<Ship> = {
    id: 207,
    type: AssetType.Ship,
    name: "Battleship",
    combat: true,
  ...
  static BATTLECRUISER: Readonly<Ship> = {
    id: 215,
    type: AssetType.Ship,
    name: "Battlecruiser",
    combat: true,
  ...
  static DESTROYER: Readonly<Ship> = {
    id: 213,
    type: AssetType.Ship,
    name: "Destroyer",
    combat: true,
  ...
  static DEATHSTAR: Readonly<Ship> = {
    id: 214,
    type: AssetType.Ship,
    name: "Deathstar",
    combat: true,
  ...
  static PATHFINDER: Readonly<Ship> = {
    id: 219,
    type: AssetType.Ship,
    name: "Pathfinder",
    combat: true,
  ...
  static SMALL_CARGO: Readonly<Ship> = {
    id: 202,
    type: AssetType.Ship,
    name: "Small Cargo",
    transport: true,
  ...
  static LARGE_CARGO: Readonly<Ship> = {
    id: 203,
    type: AssetType.Ship,
    name: "Large Cargo",
    transport: true,
  ...
  static COLONY_SHIP: Readonly<Ship> = {
    id: 208,
    type: AssetType.Ship,
    name: "Colony Ship",
    metal: 10000,
  ...
  static ESPIONAGE_PROBE: Readonly<Ship> = {
    id: 210,
    type: AssetType.Ship,
  ...
  static SOLAR_SATELLITE: Readonly<Ship> = {
    id: 212,
    type: AssetType.Ship,
  ...
  /**
   * Calculate the speed of a ship, given its base speed, the type of drive
   * used, drive techs, and player class.
   *
  ...
  static getSpeed(
    ...
    let [base, bonus] = Ships._getBaseDriveAndBonus(shipInfo, techs);
